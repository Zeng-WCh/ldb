...
*/
class LDB_share : public Handler_share {
 public:
  THR_LOCK lock;
  mysql_mutex_t mutex;
  IO *io;
...
*/
class ha_lengine : public handler {
  THR_LOCK_DATA lock;      ///< MySQL lock
  LDB_share *share;        ///< Shared lock info
  LDB_share *get_share();  ///< Get the share
 private:
  ull offset;

 public:
  ha_lengine(handlerton *hton, TABLE_SHARE *table_arg);
  ~ha_lengine() {}

  /** @brief
    The name that will be used for display purposes.
   */
  const char *table_type() const override { return "L Engine"; }
  ...
  */
  ulonglong table_flags() const override {
    /*
      ...
      used in testing.
    */
    return HA_NO_BLOBS | HA_NO_AUTO_INCREMENT | HA_NO_TRANSACTIONS;
  }
